...
export function Landing() {
  ...
  return (
    <main className="flex min-h-dvh flex-col items-center justify-center gap-12 p-6 text-center">
      {/* Language switcher */}
      <div className="absolute right-4 top-4 flex items-center gap-1 rounded-full border border-white/10 bg-white/5 p-1 animate-fade-in-up z-10">
        {LANGUAGES.map((lang) => {
          ...
          return (
            <button
              ...
              className={[
                "rounded-full p-2 text-[10px] font-semibold uppercase tracking-wide transition-colors cursor-pointer",
                active
      ...
      >
        {/* Classic */}
        <div
          className="spin-border group relative overflow-hidden rounded-2xl border border-white/10 p-6 text-left transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl"
        >
        ...
        {/* Duet */}
        <div
          className="spin-border spin-border-green group relative overflow-hidden rounded-2xl border border-white/10 p-6 text-left transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl"
        >
          <div className="flex flex-col gap-4 z-2">
            <div className="flex items-center justify-between">
              <span className="rounded-full bg-white/[0.08] px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-widest text-zinc-400">
